...
class Member(TrackingModel, models.Model):
    ...
    email = models.CharField(_("Email Address"), max_length=255, blank=False)
    phone_number = PhoneNumberField(_("Phone number"), null=True)
    address = models.CharField(_("Address"), max_length=200, blank=False)
    parent_guardian = models.CharField(_("Parent or Guardian name"), max_length=200, blank=False)
